...
## 关联项目
- [`vllm-project/vllm`](../../projects/50-framework/inference/vllm-project/vllm/) — vLLM 推理引擎实现
- [`vllm-project/vllm-ascend`](../../projects/50-framework/inference/vllm-project/vllm-ascend/) — Ascend 后端
