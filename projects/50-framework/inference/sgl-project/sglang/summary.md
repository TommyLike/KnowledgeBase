...
## 关联
- [`vllm-project/vllm`](../../projects/50-framework/inference/vllm-project/vllm/) — 竞品（推理框架，PagedAttention vs RadixAttention）
- [`sgl-project/sgl-kernel-npu`](../../projects/50-framework/inference/sgl-project/sgl-kernel-npu/) — Ascend NPU 算子库
