...
- [`vllm-project/vllm-ascend`](../../projects/50-framework/inference/vllm-project/vllm-ascend/) — 官方 Ascend NPU 后端
- [`cosdt/vllm-ascend`](../../projects/cosdt/vllm-ascend/) — 团队维护版 Ascend 后端
- [`sgl-project/sglang`](../../projects/50-framework/inference/sgl-project/sglang/) — 竞品（推理框架，RadixAttention vs PagedAttention）
